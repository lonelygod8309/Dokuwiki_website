...
jQuery(document).on('bootstrap3:page-icons', function(event) {
  ...
  var share_to = {
    ...
    'sina-weibo'  : (function(){ return [ 'http://service.weibo.com/share/share.php?url=', url, '&sharesource=weibo&title=', title ].join(''); })(),
  };
  ...
  $dw_page_icons.find('.share-sina-weibo').on('click', function() {
    window.open(share_to.reddit, 'Share to Sina-weibo', window_options);
  });
